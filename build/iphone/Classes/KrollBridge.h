...
@interface smart_appObject : KrollCoverageObject {
#else
@interface smart_appObject : KrollObject {
#endif
@private
...
extern NSString * smart_app$ModuleRequireFormat;
