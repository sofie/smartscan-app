 ...
 * Copyright (c) 2009-2011 by smart_app, Inc. All Rights Reserved.
...
//@interface smart_appObject : NSObject
//@end

@interface smart_appObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[smart_appObject class]])
		{
			for (NSString *key in [[(smart_appObject*)o modules] allKeys])
			{
