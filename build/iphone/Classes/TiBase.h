...
// in simulator we redefine to format for smart_app Developer console
...
{\
	NSString * exceptionName = [@"org.smart_app." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smart_app";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsmart_appNativeItemNone = -1, 
	UIsmart_appNativeItemSpinner = -2,
	UIsmart_appNativeItemProgressBar = -3,
	
	UIsmart_appNativeItemSlider = -4,
	UIsmart_appNativeItemSwitch = -5,
	UIsmart_appNativeItemMultiButton = -6,
	UIsmart_appNativeItemSegmented = -7,
	
	UIsmart_appNativeItemTextView = -8,
	UIsmart_appNativeItemTextField = -9,
	UIsmart_appNativeItemSearchBar = -10,
	
	UIsmart_appNativeItemPicker = -11,
	UIsmart_appNativeItemDatePicker = -12,
	
	UIsmart_appNativeItemInfoLight = -13,
	UIsmart_appNativeItemInfoDark = -14,
	
	UIsmart_appNativeItemDisclosure = -15,
	
	UIsmart_appNativeItemContactAdd = -16
};
